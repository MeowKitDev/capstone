...
export const TransactionColumn = (): ColumnsType<TransactionDTO> => {
  ...
  return [
    ...
    {
      title: () => <TableHeaderCell key='paymentTime' label={'Payment Time'} />,
      key: 'paymentTime',
      render: ({ ...props }: TransactionDTO) => {
    ...
    {
      title: () => <TableHeaderCell key='paymentDate' label={'Payment Date'} />,
      key: 'paymentDate',
      render: ({ ...props }: TransactionDTO) => {
    ...
    {
      title: () => <TableHeaderCell key='paymentMethod' label={'Payment Method'} />,
      key: 'paymentMethod',
      render: ({ ...props }: TransactionDTO) => {
    ...
    {
      title: () => <TableHeaderCell key='paymentStatus' label={'Payment Status'} />,
      key: 'paymentStatus',
      render: ({ ...props }: TransactionDTO) => {
        return (
